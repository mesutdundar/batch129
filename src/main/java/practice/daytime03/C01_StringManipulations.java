...
public class C01_StringManipulations {
    ...
    public static void main(String[] args) {
      ...
      /*  Scanner input = new Scanner(System.in);
        ...
        System.out.println(str2.replaceAll("Kalem","biber"));//Dolma biber ile bir Dunya kaleme aldik//ikinci kalemi degistirmedi cunku buyuk kucuk harf duyarlılıgı var
