...
public class ArrayLists02 {
    public static void main(String[] args) {
        //ArrayList olustururken sag tarafa(constructor) ArrayList yazmak  zorundasiniz ama
        // sol tarafaister "ArrayList" yazin isterseniz de " List " yazin, ikisi de calisir
