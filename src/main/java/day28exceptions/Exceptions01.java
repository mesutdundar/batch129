...
public class Exceptions01 {
    ...
    public static void divide(int a, int b) {
        try {
            System.out.println(a / b); // Arithmetic exception atinca sonraki kodlari calistirmayip direkt catch'e atlar
            System.out.println("I am here");// bu gozukmuyor console
        } catch (ArithmeticException e) {
            System.out.println("Do not divide by zero");
        }
        System.out.println("You are here");// buradaki calisti ama
