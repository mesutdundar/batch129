...
public class Animal {
    /*
    1) Parent Class'daki methodu ChildClass icinde ozellestirerek kullanmaya "Overriding" yapmak denir.
    2) Overriding'de method'un parantezine, method'un ismine dokunulmaz, method'un body'si degistirilir.
    3)@Override==> Override Annotation : Override kurallarinin Java tarafindan kontro edilmesini saglar
  ...
  edilmis method(Overridden Method)'un access modifier'indan dar olamaz.
   ...
   Note:Overridden Method==>protected ise Overriding method ==> protected +public
        Overridden Method==>default ise Overriding method ==> default +protected+ public
        Overridden Method==>private ise Overriding method ==> override olmaz ki acces modifier olsun. bkz 5. kural
  ...
  mevzu olamaz. O zaman tek secenek aynisi olmalidir kalir.
   ...
   secme ihtimali yoktur,geriye sadece aynisi olma ihtimali kalir.
      ...
      11) Final kelimesini "Variable"larda kullanabilirsiniz.
                    ...
                    iii) variable name buyuk harflerle kullanilir ve underscore (alttire) ikinci kelime icin!
        ...
        (polymorphism=coksekillilik)
     */
    public void eat (){//parent'daki override edilmis eat() methoduna "Overrriden Method" denir.
